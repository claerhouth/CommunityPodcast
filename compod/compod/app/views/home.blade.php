                ...
                <div class="thumbnail">
                    <div class="row">
                        <div class="col-md-3 col-md-offset-1">
                            <a href="/compod/compod/server.php/episode/{{$episode->id}}"><img class="media-object" src="public/img/episodelogos/{{ $episode->iconFile }}" alt="User avatar" width="64" height="64"></a>
                        </div>
