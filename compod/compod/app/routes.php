...
Route::get('abcpodcastoverview', array('before' => 'auth', 'uses' =>'PodcastController@showAbcPodcast'));
Route::get('zyxpodcastoverview', array('before' => 'auth', 'uses' =>'PodcastController@showZyxPodcast'));
